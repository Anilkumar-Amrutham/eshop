class ProductCategoriesController < ApplicationController
  ...
  def index
    ...
    @product_categories_grid = initialize_grid(@product_categories)
  end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to product_categories_url, notice: 'ProductCategory was successfully destroyed.' }
